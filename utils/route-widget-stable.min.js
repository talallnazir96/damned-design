var routeapp = new (function () {
  var t,
    e,
    i = "https://api.route.com",
    r = [],
    a = "USD",
    n = !1,
    d = "RouteWidget",
  ...
  function c() {
    var e, o, t;
    for (t in ((m = x()),
    (o = 1 == !(e = m) ? "rw-checked" : "rw-unchecked"),
    typeof window !== "undefined" &&
      document
        .querySelector("#" + d)
        .setAttribute("data-default-checked", e ? "false" : "true"),
    typeof window !== "undefined" &&
      (document.querySelector("#" + d + " .rw-checkbox-span").className =
        "rw-checkbox-span " + o),
    typeof window !== "undefined" &&
      (document.querySelector(
        "#" + d + " .rw-checkbox-span .rw-slider"
      ).className = "rw-slider " + o),
    typeof window !== "undefined" &&
      (document.querySelector(
        "#" + d + " .rw-checkbox-span .rw-on-text"
      ).className = "rw-on-text " + o),
    (typeof window !== "undefined" &&
      (document.querySelector(
        "#" + d + " .rw-checkbox-span .rw-off-text"
      ).className = "rw-off-text " + o),
    r)))
      r[t](
        m
          ? { insurance_selected: !m }
          : { currency: a, insurance_price: l, insurance_selected: !m }
      );
  }
  function x() {
    return (
      ...
      document.querySelector("#" + d).getAttribute("data-default-checked")
    );
  }
  function u(e, o, t, r) {
    e +=
    ...
    "stage" === r && (i = "https://api-stage.route.com");
    e = i + e;
    n.open("GET", e),
      n.setRequestHeader("token", s),
      (n.onload = function () {
        if (200 === n.status)
          try {
  ...
  function p() {
    typeof window !== "undefined" &&
      (document.querySelector("#" + d + " .route-modal").className +=
        " rm-open");
  }
  function w() {
    var e =
      typeof window !== "undefined" &&
      document.querySelector("#" + d + " .route-modal");
  ...
  function h() {
    ...
    n &&
      ((e = (e = (e = t)
        .split("@CHECKED@")
        .join(m ? "rw-checked" : "rw-unchecked")).replace(
        "@AMOUNT@",
        l
          ? ((o = l),
            a && o
      ...
      typeof window !== "undefined" &&
        ...
        typeof window !== "undefined" &&
          document
            .querySelector("#" + d + " .rw-checkbox-span")
        ...
        typeof window !== "undefined" &&
          document
            .querySelector("#" + d + " .route-rm-close-modal")
        ...
        typeof window !== "undefined" &&
          document
            .querySelector("#" + d + " .route-modal")
            .addEventListener("click", function (e) {
              e.target === this && w();
            })));
  }
  (this.get_quote = function (e, o, t, r, n) {
    (s = e),
      u(
        "/v1/quote",
